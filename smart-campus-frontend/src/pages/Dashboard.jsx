...
const Dashboard = () => {
  ...
  // Common styling for inputs to support Dark Mode
      ...
      <div className="flex bg-campus-bg min-h-screen font-sans text-campus-text transition-colors duration-300">
        ...
        <div className="ml-64 flex-1 p-10">
          ...
          <header className="flex justify-between items-center mb-10">
            ...
            <div className="bg-campus-card px-5 py-2 rounded-full shadow-sm border border-campus-border flex items-center gap-2 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              {/* Register */}
              <div className="bg-campus-card rounded-2xl shadow-sm p-8 border border-campus-border transition-colors">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              {/* Live Logs */}
              <div className="bg-campus-card rounded-2xl shadow-sm overflow-hidden border border-campus-border transition-colors">
                ...
                <div className="max-h-[350px] overflow-y-auto">
                  <table className="w-full text-left">
                    <thead className="bg-campus-bg text-campus-secondary font-bold text-xs uppercase sticky top-0">
                    <tr>
                    ...
                    {logs.map((log) => (
                        <tr key={log.id} className="hover:bg-campus-bg transition-colors">
                          <td className="px-6 py-4 font-mono text-campus-secondary">{new Date(log.timestamp).toLocaleTimeString()}</td>
                          <td className="px-6 py-4 font-bold text-campus-text">{log.user_name}</td>
                          <td className="px-6 py-4">
                            <span className="bg-campus-bg text-campus-text border border-campus-border px-3 py-1 rounded-full text-xs font-bold">
                                {log.scan_type}
                            </span>
                          </td>
